...
public class Gtpv1InformationElementsTest {
    ...
    public void testLoadMetaData() throws Exception {
        ...
        assertIE(ies, 1, Gtpv1InfoElementMetaData.Format.TV, 1);
        assertIE(ies, 128, Gtpv1InfoElementMetaData.Format.TLV, -1);
    }
    ...
    private void assertIE(final List<Gtpv1InfoElementMetaData> ies, final int type, final Gtpv1InfoElementMetaData.Format expectedFormat, int expectedOctets) {
